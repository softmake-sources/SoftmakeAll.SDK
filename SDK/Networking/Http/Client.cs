...
namespace SoftmakeAll.SDK.Networking.Http
{
    ...
    {
        #region Methods
        public static SoftmakeAll.SDK.Networking.Http.ResponseMessage Send(SoftmakeAll.SDK.Networking.Http.RequestMessage Request) => SoftmakeAll.SDK.Networking.Http.Client.SendAsync(Request, System.TimeSpan.FromSeconds(100.0D)).Result;
        public static SoftmakeAll.SDK.Networking.Http.ResponseMessage Send(SoftmakeAll.SDK.Networking.Http.RequestMessage Request, System.TimeSpan Timeout) => SoftmakeAll.SDK.Networking.Http.Client.SendAsync(Request, Timeout).Result;

        public static async System.Threading.Tasks.Task<SoftmakeAll.SDK.Networking.Http.ResponseMessage> SendAsync(SoftmakeAll.SDK.Networking.Http.RequestMessage Request, System.Threading.CancellationToken CancellationToken = default) => await SoftmakeAll.SDK.Networking.Http.Client.SendAsync(Request, System.TimeSpan.FromSeconds(100.0D), CancellationToken);
        public static async System.Threading.Tasks.Task<SoftmakeAll.SDK.Networking.Http.ResponseMessage> SendAsync(SoftmakeAll.SDK.Networking.Http.RequestMessage Request, System.TimeSpan Timeout, System.Threading.CancellationToken CancellationToken = default)
        {
            /*
             * REQUEST
             */
            ...
            SoftmakeAll.SDK.Networking.Http.ResponseMessage DefaultResponse = new SoftmakeAll.SDK.Networking.Http.ResponseMessage(System.Net.HttpStatusCode.BadRequest);
            ...
            try
            {
                ...
                using (System.Net.Http.HttpRequestMessage HttpRequestMessage = new System.Net.Http.HttpRequestMessage(Request.Method, RequestURL.PathAndQuery))
                {
                    ...
                    using (System.Net.Http.HttpResponseMessage HttpResponseMessage = await HttpClient.SendAsync(HttpRequestMessage, CancellationToken))
                    {
                        ...
                        SoftmakeAll.SDK.Networking.Http.ResponseMessage Response = new SoftmakeAll.SDK.Networking.Http.ResponseMessage(HttpResponseMessage.StatusCode, Stopwatch.Elapsed);
                            ...
                            using (System.Net.Http.HttpContent HttpContent = HttpResponseMessage.Content)
                            {
                                ...
                                if (HttpContent != null)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (new System.String[] { "br", "deflate", "gzip" }.Any(i => i == ContentEncoding))
                                        {
                                            ...
                                            using (System.IO.MemoryStream DecompressedMemoryStream = new System.IO.MemoryStream())
                                            {
                                                ...
                                                {
                                                    case "br": DecompressionStream = new System.IO.Compression.BrotliStream(CompressedMemoryStream, System.IO.Compression.CompressionMode.Decompress, false); break;
                                ...
                                {
                                    Response.SetFileDetails(ContentDisposition, ContentType, Data);
                                }
                                else
                                {
                        ...
                        return CancellationToken.IsCancellationRequested ? DefaultResponse : Response;
                    }
                }
            }
            catch (System.Exception ex)

...
namespace SoftmakeAll.SDK.Asterisk.ARI.Actions
{
	...
	public class BridgesActions : ARIBaseAction, IBridgesActions
	{
		...
		/// <summary>
		/// Add a SoftmakeAll.SDK.Asterisk.ARI.Models.Channel to a bridge.. 
		/// </summary>
		/// <param name="bridgeId">Bridge's id</param>
		...
		/// <param name="inhibitConnectedLineUpdates">Do not present the identity of the newly connected SoftmakeAll.SDK.Asterisk.ARI.Models.Channel to other bridge members</param>
		public void AddChannel(string bridgeId, string channel, string role = null, bool? absorbDTMF = null, bool? mute = null, bool? inhibitConnectedLineUpdates = null)
		{
			...
			switch((int)response.StatusCode)
            {
				...
				case 404:
					throw new AriException("Bridge not found", (int)response.StatusCode);
				case 409:
					throw new AriException("Bridge not in Stasis application; SoftmakeAll.SDK.Asterisk.ARI.Models.Channel currently recording", (int)response.StatusCode);
				case 422:
		...
		/// <summary>
		/// Remove a SoftmakeAll.SDK.Asterisk.ARI.Models.Channel from a bridge.. 
		/// </summary>
		/// <param name="bridgeId">Bridge's id</param>
		...
		/// <summary>
		/// Set a SoftmakeAll.SDK.Asterisk.ARI.Models.Channel as the video source in a multi-party mixing bridge. This operation has no effect on bridges with two or fewer participants.. 
		/// </summary>
		/// <param name="bridgeId">Bridge's id</param>
		...
		public void SetVideoSource(string bridgeId, string channelId)
		{
            ...
            {
				case 404:
					throw new AriException("Bridge or SoftmakeAll.SDK.Asterisk.ARI.Models.Channel not found", (int)response.StatusCode);
				case 409:
					throw new AriException("Channel not in Stasis application", (int)response.StatusCode);
				case 422:
					throw new AriException("Channel not in this Bridge", (int)response.StatusCode);
